// Tipos puros e helpers de site-urls SEM dependência de Zod.
// Importado por componentes client (offer-table, site-urls-dialog) para manter Zod fora do bundle cliente.
// O siteUrlsSchema (Zod) permanece em @/lib/site-urls e é usado apenas em server actions/routes.
